...
contract Bank {
    ...
    function mint(uint256 coinValue) public isOwner {
        ...
        //msg.sender.transfer(value);//not sure
    ...
    function buy(uint256 coinValue) public {
        ...
        require(coinBalance[owner] >= value, "owner's balances are not enough");
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        require(coinBalance[msg.sender] >= value, "msg.sender's coinBalances are not enough");
